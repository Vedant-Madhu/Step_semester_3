...
public class EmployeeInheritance {
    public static void main(String[] args) {
        Employee plain = new Employee("E101", "Plain", 40000.0);
        ManagerEmployee manager = new ManagerEmployee("M201", "Manager", 70000.0, 8000.0);
        InternEmployee intern = new InternEmployee("I301", "Intern", 12000.0, 10000.0);
