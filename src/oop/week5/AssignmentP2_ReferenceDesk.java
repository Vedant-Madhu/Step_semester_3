...
class ExtendedLibraryAccessEngine {
...
public class AssignmentP2_ReferenceDesk {
    public static void main(String[] args) {
        System.out.println(
                ExtendedLibraryAccessEngine.classifyAccess("protected", "SUBCLASS_DIFFERENT_PACKAGE_OWN_TYPE"));
        System.out.println(
                ExtendedLibraryAccessEngine.classifyAccess("protected", "SUBCLASS_DIFFERENT_PACKAGE_PARENT_TYPE"));
        System.out.println(ExtendedLibraryAccessEngine.describeContext("SUBCLASS_DIFFERENT_PACKAGE_OWN_TYPE"));
    }
}